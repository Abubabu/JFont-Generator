...
public class Overlay7 {
private final getImage testCase;
	
	public Overlay7(String filepath) throws IOException
	{
	...
	public double overlay(String filepath) throws IOException
	{
		...
		System.out.println(aNativeHeight);
		
		for(int ay = 0, by = 0, incrementY = 0; incrementY < (aNativeHeight / aH);   ay += aH , by += bH , incrementY++)//y  apix[ycoord][xcoord]
		{
			for(int ax = 0, bx = 0, incrementX = 0; incrementX < (aNativeWidth / aW); ax += aW, bx += bW , incrementX++)//x
			{
		...
		ImageIO.write(test, "bmp",new File("C:\\Users\\BT_1N3_22\\git\\JFont-Generator\\imageInput\\TestCropout.bmp"));
		ImageIO.write(user, "bmp",new File("C:\\Users\\BT_1N3_22\\git\\JFont-Generator\\imageInput\\UserCropout.bmp"));
